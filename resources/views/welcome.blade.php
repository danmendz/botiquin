...
<body class="relative">
    ...
    <div class="sticky top-4 z-50 ml-auto w-auto bg-white p-4 rounded-lg shadow-sm flex justify-end items-center space-x-4">
        @auth
            <a href="{{ route('dashboard') }}" class="text-red-600 hover:underline">Ir al panel</a>
        @else
            <a href="{{ route('login') }}" class="text-red-600 hover:underline">Iniciar sesión</a>
            <a href="{{ route('register') }}" class="text-red-600 hover:underline">Registrar</a>
        @endauth
    </div>
      ...
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div class="max-w-2xl text-center mx-auto">
              ...
              <p class="mt-3 text-lg text-gray-800">|
                    Te permite gestionar los medicamentos y suministros de tu botiquín de manera sencilla y eficiente. 
              </p>
              <div class="mt-6">
